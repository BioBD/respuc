...
class Aluno{
	...
	public function setTelefoneResponsavel($newTelephoneResponsavel){
		$this->telefone_responsavel = $newTelephoneResponsavel;
	}
    ...
    private static function validaCursos ($data, $errors)
    {
        if (empty($data)) 
        {
            // Tratar erro para campo vazio.
            $errors['cursos'] = "O campo não pode estar vazio!";
        } 
        return $errors;
    }
