                      ...
                      <div class="col-lg-3">
                        ...
                        <div class="col-lg-2">
                            <select  class="form-control endereco" id="uf" name="uf" required
                                ...
                                <option value="RJ" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "RJ")) echo "selected" ?>>RJ</option>
                                <option value="AC" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "AC")) echo "selected" ?>>AC</option>
                                <option value="AL" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "AL")) echo "selected" ?>>AL</option>
                                <option value="AM" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "AM")) echo "selected" ?>>AM</option>
                                <option value="AP" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "AP")) echo "selected" ?>>AP</option>
                                <option value="BA" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "BA")) echo "selected" ?>>BA</option>
                                <option value="CE" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "CE")) echo "selected" ?>>CE</option>
                                <option value="DF" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "DF")) echo "selected" ?>>DF</option>
                                <option value="ES" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "ES")) echo "selected" ?>>ES</option>
                                <option value="GO" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "GO")) echo "selected" ?>>GO</option>
                                <option value="MA" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "MA")) echo "selected" ?>>MA</option>
                                <option value="MG" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "MG")) echo "selected" ?>>MG</option>
                                <option value="MS" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "MS")) echo "selected" ?>>MS</option>
                                <option value="MT" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "MT")) echo "selected" ?>>MT</option>
                                <option value="PA" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "PA")) echo "selected" ?>>PA</option>
                                <option value="PB" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "PB")) echo "selected" ?>>PB</option>
                                <option value="PE" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "PE")) echo "selected" ?>>PE</option>
                                <option value="PI" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "PI")) echo "selected" ?>>PI</option>
                                <option value="PR" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "PR")) echo "selected" ?>>PR</option>
                                <option value="RN" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "RN")) echo "selected" ?>>RN</option>
                                <option value="RO" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "RO")) echo "selected" ?>>RO</option>
                                <option value="RR" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "RR")) echo "selected" ?>>RR</option>
                                <option value="RS" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "RS")) echo "selected" ?>>RS</option>
                                <option value="SC" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "SC")) echo "selected" ?>>SC</option>
                                <option value="SE" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "SE")) echo "selected" ?>>SE</option>
                                <option value="SP" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "SP")) echo "selected" ?>>SP</option>
                                <option value="TO" <?php if (!empty($aprendiz->getUf()) && ($aprendiz->getUf() == "TO")) echo "selected" ?>>TO</option>
                            </select>
                        </div>
                  </div>
              </div>
