      ...
      <form method="post" action="save" enctype="multipart/form-data">
        ...
        <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="hidden" name="old_nome" value="<?php echo $curso->getNome()?>">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="Digite o coordenador"
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="Digite o epartamento"
