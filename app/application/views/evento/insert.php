        ...
        <div class="row">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="Digite a presença"
                               name="presencas" onkeypress="return validateLetterInput(event);" required
                               oninvalid="this.setCustomValidity('Este campo não pode ficar vazio.')"
                               oninput="setCustomValidity('')"
                               value="<?php
                               if (!empty($_POST['presencas'])) {
                                   echo $_POST['presencas'];
                               }
                               ?>"/>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <input type="text" class="form-control" placeholder="Digite o descrição"
