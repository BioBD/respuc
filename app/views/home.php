        ...
        <div id="rev_slider_66_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.0.7">
            <ul>	<!-- SLIDE  -->
                <li data-index="rs-227" data-transition="slidevertical" data-slotamount="1"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="views/upload/slide/1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption WebProduct-Title-Light   tp-resizeme"
                         ...
                         style="z-index: 11; white-space: nowrap;">Helping Children<br/>By Donate Us!
                    </div>
                    ...
                    <div class="tp-caption WebProduct-Content-Light   tp-resizeme"
                         ...
                         style="z-index: 13; min-width: 448px; max-width: 448px; white-space: normal;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer adipiscing erat eget risus sollicitudin pellentesque et non erat..
                    </div>
                    ...
                    <a class="tp-caption WebProduct-Button"
                       ...
                       style="z-index: 14; white-space: nowrap;letter-spacing:1px;">Donate
                    </a>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-228" data-transition="slidevertical" data-slotamount="1"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-rotate="0"  data-saveperformance="off"  data-title="Examples" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="views/upload/slide/2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption WebProduct-Title-Light   tp-resizeme"
                         ...
                         style="z-index: 11; white-space: nowrap;">Give life to the arid <br/>African childrens
                    </div>
                ...
                <li data-index="rs-229" data-transition="slidevertical" data-slotamount="1"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-rotate="0"  data-saveperformance="off"  data-title="Get a License" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="views/upload/slide/3.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption WebProduct-Title-Light tp-resizeme"
                         ...
                         style="z-index: 6; white-space: nowrap;text-align:center;">Let orphans feel<br/>
                    ...
                    <div class="tp-caption WebProduct-Content-Light   tp-resizeme"
                         ...
                         style="z-index: 8; min-width: 448px; max-width: 448px; white-space: normal;text-align:center;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
                    </div>
                    ...
                    <a class="tp-caption WebProduct-Button"
                       ...
                       style="z-index: 9; white-space: nowrap;letter-spacing:1px;">Donate
                    </a>
                </li>
            </ul>
        ...
        <div class="news-box">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="news-post">
                        <div class="news-gallery">
                            <img src="views/upload/blog/proj-1.jpg" alt="">
                        </div>
                        <div class="news-content">
                            <h2><a href="single-post.html">Accusamus et iusto odio dignissimos dimus </a></h2>
                            <span class="date">4 jannuary 2016</span>
                ...
                <div class="col-md-4">
                    <div class="news-post">
                        <div class="news-gallery">
                            <img src="views/upload/blog/proj-2.jpg" alt="">
                        </div>
                        <div class="news-content">
                ...
                <div class="col-md-4">
                    <div class="news-post">
                        <div class="news-gallery">
                            <img src="views/upload/blog/proj-4.jpg" alt="">
                        </div>
                        <div class="news-content">
                            <h2><a href="single-post.html">Nam dui mi, tincidunt quis, accumsan porttitor.</a></h2>
                            <span class="date">4 jannuary 2016</span>
                            <a class="comm-number" href="#"><i class="fa fa-comments"></i> 4 comments</a>
                        </div>
                    </div>
